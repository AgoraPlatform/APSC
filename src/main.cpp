...
const string strMessageMagic = "Agora Signed Message:\n";
...
{
    int64_t nSubsidy;
    if (IsProtocolV3(pindexPrev->nTime) && nBestHeight <= 200000)
        nSubsidy = (COIN * 36) + nCoinAge * COIN_YEAR_REWARD_V1 * 33 / (365 * 33 + 8);
    else if (IsProtocolV3(pindexPrev->nTime) && nBestHeight <= 550000)
        nSubsidy = (COIN * 24) + nCoinAge * COIN_YEAR_REWARD_V2 * 33 / (365 * 33 + 8);
    else if (IsProtocolV3(pindexPrev->nTime) && nBestHeight > 550000)
        nSubsidy = (COIN * 10) + nCoinAge * COIN_YEAR_REWARD_V3 * 33 / (365 * 33 + 8);
    else
        nSubsidy = nCoinAge * COIN_YEAR_REWARD_V1 * 33 / (365 * 33 + 8);
