...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: agora.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: agorad.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 18536 or testnet: 28536)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 18537 or testnet: 28537)") + "\n";
