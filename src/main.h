...
static const int64_t COIN_YEAR_REWARD_V1 = 130 * CENT;
static const int64_t COIN_YEAR_REWARD_V2 = 70 * CENT;
static const int64_t COIN_YEAR_REWARD_V3 = 30 * CENT;

inline bool IsProtocolV1RetargetingFixed(int nHeight) { return TestNet() || nHeight > 100; }
inline bool IsProtocolV2(int nHeight) { return TestNet() || nHeight > 900; }
inline bool IsProtocolV3(int nHeight) { return TestNet() || nHeight > 1000; }
